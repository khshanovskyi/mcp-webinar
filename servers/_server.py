...
async def get_flow_diagram() -> bytes:
    ...
    image_path = Path(__file__).parent / "_responses" / "flow.png"
...
async def get_service_description() -> str:
    ...
    text_path = Path(__file__).parent / "_responses" / "service_description.txt"

    if not text_path.exists():
        raise FileNotFoundError("service_description.txt not found")
